...
def main(writer, name, batch_size=256):
    ...
    # load data
    data_dirs = [
        '/home/local/ASUAD/yzhou298/Documents/projects/intro_paper/tiny_ur5/collected5',
        '/home/local/ASUAD/yzhou298/Documents/projects/intro_paper/tiny_ur5/collected7_random_init_angles'
    ]
    ...
    data_dirs_val = [
        '/home/local/ASUAD/yzhou298/Documents/projects/intro_paper/tiny_ur5/collected6'
    ]
    dataset_val_dmp = DMPDatasetEERandTarXYLang(data_dirs, random=False, length_total=60, normalize='none')
...
if __name__ == '__main__':
    name = 'train-baseline-bcz-film-resnet-huberloss-2-larger-dataset'
